...
public class AuthServiceImpl implements AuthService {
    ...
    public JwtAuthenticationDto refreshToken(RefreshTokenDto refreshTokenDto) throws Exception {
        ...
        throw createAndLogGatewayException("TOKEN_EXPIRED_EXCEPTION", "Invalid refresh token", null);
    }
    ...
    private User findByCredentials(UserCredentialsDto userCredentialsDto) throws AuthenticationException {
        ...
        throw createAndLogGatewayException("AUTH_ERROR", "Email or password is not correct", null);
    }

    private User findByEmail(String email) throws Exception {
        return userRepository.findByEmail(email).orElseThrow(()->
                createAndLogGatewayException("AUTH_ERROR",
